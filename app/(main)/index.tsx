 ...
 const handleLogout = async () => {
  ...
  return (
    <View style={[styles.container, { backgroundColor: theme.background }]}>
      ...
      <Text style={[styles.subtitle, { color: theme.muted }]}>Your ultimate URL shortener and analytics dashboard</Text>

      <TouchableOpacity style={[styles.button, { backgroundColor: theme.primary }]} onPress={() => router.push('/(main)/CreateUrl')}>
        <Text style={styles.buttonText}>Create URL</Text>
      </TouchableOpacity>

      <TouchableOpacity style={[styles.button, { backgroundColor: theme.primary }]} onPress={() => router.push('/(main)/Analytics')}>
